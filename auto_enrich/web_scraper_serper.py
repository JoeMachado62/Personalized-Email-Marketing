...
try:
    ...
    class SerperWebGatherer:
        """
        Web data gatherer using Serper API for search and enhanced content extraction.
        ...
        async def search_and_gather(self, company_name: str, location: str = "",
            ...
            """
            Main method: Search for company using Serper and enhanced content extraction.
            ...
            try:
                ...
                if search_results:
                    ...
                    if website_url:
                        ...
                        # Step 3: Extract website content using enhanced extractor
                        try:
                            website_content = await self.content_extractor.extract(website_url)
                            if website_content:
                            ...
                            logger.warning(f"Content extraction failed, using basic extraction: {e}")
        ...
        def _extract_from_search_results(self, search_results: List[Dict]) -> Dict:
            """Extract basic data from search results when content extraction fails."""
            data = {
                'title': '',
                'description': '',
                'snippets': []
        ...
        async def _scrape_website(self, url: str) -> Dict[str, Any]:
            ...
            """
            try:
                return await self.content_extractor.extract(url)
            except Exception as e:
